...
class PedidosecoPage extends StatefulWidget {
  PedidosecoPage({Key key}) : super(key: key);

  @override
  _PedidosecoPageState createState() => _PedidosecoPageState();
}

class _PedidosecoPageState extends State<PedidosecoPage> {
  ...
  void _submit(
    ...
    pedido.aquien = ecoemprendimiento.nombre;
    pedido.correo2 = ecoemprendimiento.correo;
    pedido.tipo = 'ecoemprendimiento';
    ...
    pedido.actor = 'Ecoemprendimiento';
  ...
  void _mensajes(BuildContext context) {
    String toLaunch =
        'https://wa.me/591${ecoemprendimiento.celular}?text=Hola, solicitud de contacto a través de REDCICLA';
    showDialog(
        context: context,
