...
class Ecoemprendimiento2Page extends StatefulWidget {
  Ecoemprendimiento2Page({Key key}) : super(key: key);

  @override
  _Ecoemprendimiento2PageState createState() => _Ecoemprendimiento2PageState();
}
...
class _Ecoemprendimiento2PageState extends State<Ecoemprendimiento2Page> {
...
// dias de la semana
                      ...
                      _tienedenuncia(ecoemprendimiento),
                      SizedBox(
                        height: 30.0,
                      ),
                      _mapear(),
  ...
  Widget _tienedenuncia(Ecoemprendimiento acopiador) {
    return Row(
      children: <Widget>[
  ...
  Widget _elegirciudad() {
    return Row(
      children: <Widget>[
        ...
        Expanded(
          child: DropdownButton(
            value: ecoemprendimiento.ciudad,
            style: TextStyle(color: Color.fromRGBO(34, 181, 115, 1.0)),
