...
class MisRegistros extends StatefulWidget {
  // const Inicio({Key key}) : super(key: key);
  @override
  _MisRegistrosState createState() => _MisRegistrosState();
}
...
class _MisRegistrosState extends State<MisRegistros> {
                    ...
                    return ListView.builder(
                      itemBuilder: (context, i) {
                        if (_centrosAcopiofiltrado[i].ciudad == _ciudad &&
                            _centrosAcopio[i].correo == prefs.email) {
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          if (ecoemprendimientos[i].ciudad == _ciudad &&
                              ecoemprendimientos[i].correo == prefs.email) {
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          if (recicladoras[i].departamento == _ciudad &&
                              recicladoras[i].correo == prefs.email) {
  ...
  Widget _itemRecicladora(BuildContext context, Recicladora recicladora) {
    ...
    return Dismissible(
      ...
      child: (ListTile(
        ...
        onTap: () => Navigator.pushNamed(context, 'recicladoras',
  ...
  _explicacion() {
    return Container(
      ...
      child: Center(
        child: Text(
            "En esta sección puedes editar o eliminar los registros que hiciste en la base de datos. Recuerda que una vez eliminados no podrás recuperar esos registros.\n"
            "Para editar haz clic en el elemento que quieres modificar, para eliminar desliza el elemento hacia la derecha"),
      ),
    );
  }
}
