...
class VistaEcoemprendimiento extends StatefulWidget {
  @override
  _VistaEcoemprendimientoState createState() => _VistaEcoemprendimientoState();
}

ScreenshotController screenshotController = ScreenshotController();

class _VistaEcoemprendimientoState extends State<VistaEcoemprendimiento> {
    ...
    final imagen = Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
              image: NetworkImage(ecoemprendimiento.fotourl), fit: BoxFit.fill),
        ...
        TableRow(key: RIKeys.riKey1, children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Ciudad: ' + ecoemprendimiento.ciudad,
                  style: TextStyle(
                      color: Colors.white,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ecoemprendimiento.celular + ecoemprendimiento.direccion,
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 17.0,
                  ),
    ...
    return Column(
      children: <Widget>[
        ...
        RaisedButton.icon(
          ...
          onPressed: () => Navigator.pushNamed(context, 'pedidoseco',
              arguments: ecoemprendimiento),
    ...
    return Column(
      children: <Widget>[
        ...
        RaisedButton.icon(
          ...
          color: Colors.red,
          textColor: Colors.white,
          onPressed: () => Navigator.pushNamed(context, 'denunciaseco',
              arguments: ecoemprendimiento),
